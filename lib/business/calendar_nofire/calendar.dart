  ...
  Widget build(BuildContext context) {
   ...
   final user = Provider.of<UserProvider>(context).user;
    ...
    return Scaffold(
      ...
      floatingActionButton: worker!=null? FloatingActionButton.extended(
        splashColor: Colors.red[200],
        backgroundColor:Colors.red[200],
        onPressed: () => showDialog(
          context: context,
          builder: (context) => AlertDialog(
            title: Text("Add a reservation"),
              ...
              TextButton(
                ...
                onPressed: () {
                  if (_eventController.text.isEmpty) {
                    ...
                    if (_selectedEvents[selectedDay] != null) {
                  ...
                  prefs.setString("events", json.encode(encodeMap(_selectedEvents)));
