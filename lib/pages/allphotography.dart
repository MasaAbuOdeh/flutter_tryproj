...
class allphotography extends StatefulWidget{
const allphotography({Key? key}):super(key:key);
 ...
 // get temp =>null;
  //get workerdata => null;
@override
_allphotographyState createState()=> _allphotographyState();


}
class _allphotographyState extends State<allphotography> with TickerProviderStateMixin {
...
double aj=0;
  ...
  Future showallhalls() async{
    ...
    workers = await hall.showAllphotograpth(context);
    ...
    if (totalRatingg != 0) {
      ...
      avgRating=0.0;
                  ...
                  return GestureDetector(
                        onTap: () {
                          Navigator.of(context).pushNamed('/Detailphoto',arguments: workers![index]);Colors.red[200];
