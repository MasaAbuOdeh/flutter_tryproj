...
class bandlowrate extends StatefulWidget{
const bandlowrate({Key? key}):super(key:key);
 ...
 // get temp =>null;
  //get workerdata => null;
@override
_bandlowrateState createState()=> _bandlowrateState();


}
class _bandlowrateState extends State<bandlowrate> with TickerProviderStateMixin {
  List <Worker> ? workers ;
  ...
  Widget build(BuildContext context) {
   ...
   // recomend=workers;
    ...
    return workers == null
        ...
        : Scaffold(
          appBar: AppBar(
            title: Text("Rating from high to low"),
