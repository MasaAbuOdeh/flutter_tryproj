...
class Nablushalls extends StatefulWidget{
const Nablushalls({Key? key}):super(key:key);
 ...
 // get temp =>null;
  //get workerdata => null;
@override
_NablushallsState createState()=> _NablushallsState();


}
class _NablushallsState extends State<Nablushalls> with TickerProviderStateMixin {
  List <Worker> ? workers ;
  ...
  showallhalls() async{
    ...
    workers = await hall.showhallsNablus(context);
    setState(() {
