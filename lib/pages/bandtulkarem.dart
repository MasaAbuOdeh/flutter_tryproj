...
class tulband extends StatefulWidget{
const tulband({Key? key}):super(key:key);
 ...
 // get temp =>null;
  //get workerdata => null;
@override
_tulbandState createState()=> _tulbandState();


}
class _tulbandState extends State<tulband> with TickerProviderStateMixin {
  List <Worker> ? workers ;
  ...
  showallhalls() async{
    ...
    workers = await hall.showbandTulkarem(context);
    setState(() {
