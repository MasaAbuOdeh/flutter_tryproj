...
class LHprice extends StatefulWidget{
const LHprice({Key? key}):super(key:key);
 ...
 // get temp =>null;
  //get workerdata => null;
@override
_LHpriceState createState()=> _LHpriceState();


}
class _LHpriceState extends State<LHprice> with TickerProviderStateMixin {
  List <Worker> ? workers ;
